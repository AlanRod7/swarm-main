document.addEventListener('DOMContentLoaded', function () {
    ...
    const ejecutarMooraaco = document.getElementById('ejecutarMooraaco');
    const formularioMooraaco = document.getElementById('mooraacoForm');
    

    ejecutarMooraaco.addEventListener('click', function () {
        console.log('ejecutarMooraaco clicked');

        //Obtener datos del formulario
        const formData = new FormData(formularioMooraaco);
    ...
    formularioMooraaco.addEventListener('submit', function (event) {
